...
class Client  extends  BaseClient{
    ...
    const Model1 = 'https://picupapi.tukeli.net/api/v1/matting?mattingType=2';
    const Model2 = 'https://picupapi.tukeli.net/api/v1/matting2?mattingType=2';
    const Model3 = 'https://picupapi.tukeli.net/api/v1/mattingByUrl?mattingType=2';
