...
class Client  extends  BaseClient{
    ...
    const Model1 = 'https://picupapi.tukeli.net/api/v1/matting?mattingType=3';
    const Model2 = 'https://picupapi.tukeli.net/api/v1/matting2?mattingType=3';
    const Model3 = 'https://picupapi.tukeli.net/api/v1/mattingByUrl?mattingType=3';
